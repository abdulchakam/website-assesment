        ...
        <div class="col-md-10">
            ...
            <div class="card mt-4 card-custom">
                ...
                <div class="card-footer text-right">
                    <a href="{{ url('/dashboard') }}"class="btn btn-warning px-4 mr-2 radius-10 btn-kembali"><i class="fas fa-chevron-left mr-2"></i>Kembali</a>
                    <a href="{{ url('/dashboard') }}"class="btn btn-danger px-4 mr-2 radius-10 btn-batal" hidden><i class="fas fa-ban mr-2"></i>Batal</a>
