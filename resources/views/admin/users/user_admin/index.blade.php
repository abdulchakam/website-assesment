    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="table-responsive">
                <table id="tabel_user_admin" class="table table-hover">
                        <thead>
                            <tr>
                                <th>Name </th>
                                <th>Username</th>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="multiple-oneModalLabel">Tambah User</h4>
                    ...
                    submitHandler: function(form){
                        ...
                        $.ajax({
                            ...
                            success: function(data){
                                ...
                                var table = $('#tabel_user_admin').DataTable();
